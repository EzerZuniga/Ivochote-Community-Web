...
const ICON_PATHS: Record<string, string> = {
  river:     "M3 12c3-4 6-4 9 0s6 4 9 0M3 6c3-4 6-4 9 0s6 4 9 0M3 18c3-4 6-4 9 0s6 4 9 0",
  forest:    "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M9 7h.01M15 11h.01M12 3l3 6H9l3-6z",
  coffee:    "M18 8h1a4 4 0 010 8h-1M2 8h16v9a4 4 0 01-4 4H6a4 4 0 01-4-4V8zm4-7v3m4-3v3m4-3v3",
...
const CATEGORY_STYLE: Record<string, { iconBg: string; badge: string; accent: string }> = {
  naturaleza:  { iconBg: "bg-emerald-700", badge: "bg-emerald-100 text-emerald-800", accent: "bg-emerald-600" },
  gastronomia: { iconBg: "bg-amber-700",   badge: "bg-amber-100 text-amber-800",   accent: "bg-amber-500"   },
  cultura:     { iconBg: "bg-primary-700", badge: "bg-primary-100 text-primary-800", accent: "bg-primary-600" },
  aventura:    { iconBg: "bg-rose-700",    badge: "bg-rose-100 text-rose-800",     accent: "bg-rose-500"    },
};
